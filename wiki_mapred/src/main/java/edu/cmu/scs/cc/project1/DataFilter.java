 ...
 * </p>
 *
 * <p>We provide you with the starting template, as well as the code of constants,
...
public final class DataFilter {
     ...
     * encoding.
     * {@link java.io.OutputStreamWriter#OutputStream} and
    ...
    static boolean checkSpecialPage(final String[] columns) {
        ...
        for (String specialPage : SPECIAL_PAGES) {
            if (columns[1].equals(specialPage)) return false;
        }
        return true;
    }
    ...
    static boolean checkPrefix(final String[] columns) {
        // throw new RuntimeException("To be implemented");
        String title = columns[1].toLowerCase();
    ...
    static boolean checkFirstLetter(final String[] columns) {
        // throw new RuntimeException("To be implemented");
        char firstLetter = columns[1].charAt(0);
